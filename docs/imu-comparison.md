...
LSM6DSV is the best IMU in terms of performance since the 2024. LSM6DSV offers consistent +45min resets. Much higher and most importantly consistent reset times over all budget BMI270, LSM6DSO, ICM-45686 IMU options. Neither LSM or BMI requires a stable magnetic environment. 

BNO085 IMUs main feature is sensor fusion with integrated magnetometer. This IMU requires a stable magnetic enviroment to perform well. Majority of homes do not have good magnetic enviroment. For this reason, SlimeVR trackers using BNO085 IMUs are sold with the featured turned off and do perform rather poor on a level with budget IMUs like the BMI270, Making the BNO085 a bad price to performance choice.
